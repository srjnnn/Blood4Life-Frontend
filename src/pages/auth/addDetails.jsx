  ...
  return (
    <div className="min-h-dvh bg-white flex flex-col items-center">
      <div className="w-full h-[10vh] md:h-[15vh] bg-[#c30000] text-white rounded-b-[30px] flex pt-3 justify-between">
        ...
        <h1 className="text-base font-medium">Add details</h1>
      ...
      <form
        ...
        className="w-full md:w-128 flex-1 px-6 mt-6 flex flex-col space-y-4"
      >
        <div>
        ...
        <div>
          <label className="text-sm text-red-700 font-medium">Gender</label>
          <select
            name="gender"
